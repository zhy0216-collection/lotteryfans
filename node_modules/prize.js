    ...
    self._randomSelect = function(chooseTime){
        ...
        for(var i =0; i < chooseTime; i++){
            while(1){
                ...
                if(!self.peopleList.isLastTwoDigitsSelected(digit0, digit1)){
    ...
    prize._randomSelect = function(chooseTime){
        if(prize.digit0 == null){
            while(1){
                ...
                console.log("digit0 OK?:" + !prize.peopleList.isLastDigitSelected(prize.digit0))
                if(!prize.peopleList.isLastDigitSelected(prize.digit0)){
                    break;
                }
            }
        }else{
            while(1){
                ...
                if(!prize.peopleList.isLastTwoDigitsSelected(prize.digit0, prize.digit1)){
                    prize.peopleList.randomSelectByLastTwoDigits(prize.prizeName, 10*prize.digit0 + prize.digit1);
                    break;
                }
            }
        ...
        if(prize.digit0 != null && prize.digit1 != null ){
