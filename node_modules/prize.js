...
function Prize(image, degree, peopleList, selectPerTime){
    var self = this;
    ...
    self.init = function(image, degree, peopleList, selectPerTime){
        self.image = image;
        self.degree = degree;
    ...
    self._randomSelect = function(chooseTime){
        ...
        for(var i =0; i < chooseTime; i++){
            while(1){
                ...
                if(_people.length != 0){
                    self.peopleList.randomSelectByLastTwoDigits(true, 10*digit0 + digit1);
                    break;
                }
    ...
    self.init(image, degree, peopleList, selectPerTime);
...
function SpecialPrize(image, degree, peopleList, selectPerTime){
    var prize = new Prize(image, degree, peopleList, selectPerTime);
    ...
    prize._randomSelect = function(chooseTime){
        var people = prize.peopleList.randomSelect(true);
